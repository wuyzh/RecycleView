 ...
 * @author wuyzh
 * */
public class DragRecycleViewAdapter extends RecyclerView.Adapter<DragRecycleViewAdapter.DemoViewHolder> {
    private Context mContext;
    private List<String> mList;
    private OnItemClickListener mOnItemClickListener;

    public DragRecycleViewAdapter(Context context, List<String> list){
        mContext = context;
        mList = list;
    }
    /**
