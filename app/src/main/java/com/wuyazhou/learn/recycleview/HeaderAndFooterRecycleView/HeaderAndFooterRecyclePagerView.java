 ...
 * @function
 */
public class HeaderAndFooterRecyclePagerView extends FrameLayout implements View.OnClickListener,LinearRecycleViewAdapter.OnItemClickListener {
    ...
    private HeaderAndFooterRecycleViewAdapter mHeaderAndFooterRecycleViewAdapter;

    private View mHeaderView;
    private View mFooterView;

    public HeaderAndFooterRecyclePagerView(Context context) {
        super(context);
        mContext = context;
        initView();
        initData();
    ...
    public HeaderAndFooterRecyclePagerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
        initView();
        initData();
    ...
    public HeaderAndFooterRecyclePagerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initView() {
        ...
        mHeaderView = inflater.inflate(R.layout.item_progress_layout, null);
        mFooterView = inflater.inflate(R.layout.item_progress_layout, null);
    ...
    private void initData(){
        ...
        mHeaderAndFooterRecycleViewAdapter = new HeaderAndFooterRecycleViewAdapter(mLinearRecycleViewAdapter);
        mHeaderAndFooterRecycleViewAdapter.addHeaderView(mHeaderView);
        mHeaderAndFooterRecycleViewAdapter.addFooterView(mFooterView);
        mRecyclerView.setAdapter(mHeaderAndFooterRecycleViewAdapter);
    }
